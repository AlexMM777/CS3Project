...
public class FootSteps : MonoBehaviour
{
    ...
    public AudioClip[] stoneSteps, grassSteps;
    public int stoneIndex, grassIndex, strawIndex;
    ...
    void Update()
    {
        ...
        {
            if(playerController.GetComponent<TerrainSurface>().groundIndex == stoneIndex)
            {
                chosenSounds = stoneSteps;
                ChooseRandom();
            }
            if (playerController.GetComponent<TerrainSurface>().groundIndex == grassIndex)
            {
                chosenSounds = grassSteps;
                ChooseRandom();
            }
            if (playerController.GetComponent<TerrainSurface>().groundIndex == strawIndex)
            {
                chosenSounds = grassSteps;
                ChooseRandom();
            }
